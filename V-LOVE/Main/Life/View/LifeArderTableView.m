...
@implementation LifeArderTableView
...
- (instancetype)initWithFrame:(CGRect)frame style:(UITableViewStyle)style{
    ...
    if (self) {
        ...
        UINib * nib = [UINib nibWithNibName:@"LifeArderTableViewCell" bundle:[NSBundle mainBundle]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0)
    {
        NSString *path = [[NSBundle mainBundle] pathForResource:@"LifePlay" ofType:@"plist"];
        ...
        LifeArderTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
        LifePlayModel *model = _data[indexPath.section - 1];
        cell.model = model;
